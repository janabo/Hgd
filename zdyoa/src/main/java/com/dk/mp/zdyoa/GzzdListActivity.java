...
/**
 * 规章制度
 * 作者：janabo on 2017/3/17 10:32
 */
public class GzzdListActivity extends MyActivity implements View.OnClickListener{
    ...
    public void getList(){
        ...
        HttpUtil.getInstance().gsonRequest(new TypeToken<PageMsg<Gzzd>>(){}, "apps/oa/getGzzdList", map, new HttpListener<PageMsg<Gzzd>>() {
            @Override
