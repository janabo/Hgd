...
/**
 * 通知公告
 * 作者：janabo on 2017/3/17 13:41
 */
public class TzggListActivity extends MyActivity implements View.OnClickListener{
    ...
    public void getList(){
        ...
        HttpUtil.getInstance().gsonRequest(new TypeToken<PageMsg<Gzzd>>(){}, "apps/oa/tzgglist", map, new HttpListener<PageMsg<Gzzd>>() {
            @Override
