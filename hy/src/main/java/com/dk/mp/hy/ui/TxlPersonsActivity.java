...
import com.dk.mp.hy.http.Manager;
...
public class TxlPersonsActivity extends MyActivity{
    ...
    List<HyJbxx> mList = new ArrayList<>();
    TxlAdapter mAdapter;
    ...
    protected int getLayoutID() {
        return R.layout.app_hy_persons;
    }
...
//        map.put("id",bmid);
            ...
            public void onSuccess(JSONObject result)  {
                try {
                    if (result.getInt("code") != 200) {
                        ...
                        List<HyJbxx> departments = Manager.getPeoples(result,bmid,bmname);
    ...
    public void getBmDataByLocal(int par){
        List<HyJbxx> persons = mRealmHelper.queryPersonsByDepartmentid(bmid);//从本地存储获取数据
